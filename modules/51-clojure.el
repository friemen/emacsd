...
(defun my-clojure-keybindings ()
     ...
     (define-key clojure-mode-map (kbd "C->") 'mc/mark-next-symbol-like-this)
     (define-key clojure-mode-map (kbd "C-<") 'mc/mark-previous-symbol-like-this)
     (define-key clojure-mode-map (kbd "C-M-<") 'mc/mark-all-symbols-like-this-in-defun)
