...
(custom-set-faces
 ...
 '(mode-line ((t :foreground "#ffffff" :background "#81a1c1" :inverse-video nil)))
 '(mode-line-inactive ((t :foreground "grey20" :background "Gainsboro" :inverse-video nil)))
 '(region ((t (:background "#7DB0BF" :foreground "#ffffff"))))
